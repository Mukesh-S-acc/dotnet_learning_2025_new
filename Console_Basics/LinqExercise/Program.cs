...
class Program
{
    ...
    public static void Main()
    {
        ...
        List<Employee> employees = new List<Employee>
        
            {
                ...
                new Employee { Empid=4, EmpName="John", City="Pune", Salary=0, Deptno=10 },
                new Employee { Empid=5, EmpName="Anna", City="Coimbatore", Salary=0, Deptno=10 },
                new Employee { Empid=6, EmpName="Mike", City="Pune", Salary=0, Deptno=10 },
         };
    ...
    //    { Console.WriteLine($"Dept: {dept.DeptNo},Avg Salary: {dept.AvgSalary}"); }
        ...
        {
        DeptNo = g.Key,
        EmployeeNames = g.Select(e => e.EmpName)
        });
